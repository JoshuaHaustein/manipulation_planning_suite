    ...
    namespace planner {
        namespace util {
            namespace yaml {
                ...
                std::string valueFnTypeToString(mps::planner::pushing::PlanningProblem::OracleType oracle_type);
                ...
                mps::planner::sorting::PlanningProblem::ValueFnType stringToValueFnType(const std::string& str);
...
namespace YAML {
    ...
    struct convert<mps::planner::util::yaml::SortingPlanningProblemDesc> {
        static Node encode(const mps::planner::util::yaml::SortingPlanningProblemDesc &problem_desc) {
            ...
            node["sorting_groups"] = sorting_groups;
