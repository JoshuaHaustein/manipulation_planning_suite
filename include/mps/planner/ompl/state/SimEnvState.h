    ...
    namespace ompl {
        namespace state {
            ...
            public:
                ...
                /**
                 *  The same as the other isValid function, but instead only evaluates the currently 
                 * set state of the underlying SimEnv world. 
                 */
                bool isWorldStateValid(bool check_bounds = true) const;
