    ...
    const Eigen::Affine2f& zTr) const
{
    ...
    for (unsigned int i = 0; i < num_samples; ++i) {
        ...
        Eigen::Affine2f wTz = Eigen::Translation2f(_se2_state_c->getX(), _se2_state_c->getY()) * Eigen::Rotation2Df(_se2_state_c->getYaw());
